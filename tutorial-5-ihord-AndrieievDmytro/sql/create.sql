...
INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 130, GETDATE());

INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 150, GETDATE());
INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 160, GETDATE());

INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 170, GETDATE());
...
INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 190, GETDATE());
INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 200, GETDATE());

INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 210, GETDATE());
INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 220, GETDATE());

INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 230, GETDATE());

INSERT INTO "Order"(IdProduct, Amount, CreatedAt)
VALUES((SELECT IdProduct FROM Product WHERE Name='Abacavir'), 240, GETDATE());


SELECT @@IDENTITY;

SELECT TOP 1 IdProductWarehouse from Product_Warehouse
ORDER BY  IdProductWarehouse DESC ;
